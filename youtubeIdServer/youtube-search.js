...
app.use(
  cors({
    origin: ["http://127.0.0.1:5500","http://127.0.0.1:5501", "http://127.0.0.1:8000/", "http://35.226.51.35:8000"],   // allow requests from this origin     // allow requests from this origin 
  })
)
